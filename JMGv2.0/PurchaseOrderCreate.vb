...
Public Class PurchaseOrderCreate
    ...
    Private Sub PurchaseOrderCreate_Load(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        End If
    End Sub
    Private Sub PurchaseOrderCreate_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
